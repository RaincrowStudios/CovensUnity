...
origin_branch = input('Origin Branch [default is dev/2.8.8]: ') 
origin_branch = origin_branch or 'dev/2.8.8'
...
target_branch = input('Target Branch [default is release/2.8.8]: ') # get target branch
target_branch = target_branch or 'release/2.8.8'
