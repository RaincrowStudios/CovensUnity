...
#if ENABLE_GOOGLE_MAPS_LOCATION_AUTH && UNITY_ANDROID && !UNITY_EDITOR
    /// <summary>Android object that provides location signals.</summary>
    private AndroidJavaObject LocationAuthSignalsProvider;
#endif

#if ENABLE_GOOGLE_MAPS_LOCATION_AUTH && UNITY_IOS && !UNITY_EDITOR
...
#if UNITY_EDITOR
      return false;
#elif ENABLE_GOOGLE_MAPS_LOCATION_AUTH && UNITY_ANDROID
...
#elif ENABLE_GOOGLE_MAPS_LOCATION_AUTH && UNITY_IOS
...
#if ENABLE_GOOGLE_MAPS_LOCATION_AUTH && UNITY_IOS
