...
namespace Oktagon.Localization
{
    public class LokakiOld
    {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!pTextData.HasCheckedDynamicTag())
                        {
                            ...
                            bool bContains = LokakiOld.ContainsDynamicTags(pTextData.GetValue());
        ...
        public static LANGUAGES GetSystemLanguage()
        {
            ...
            {
                LANGUAGES eLanguage = (LokakiOld.LANGUAGES)System.Enum.Parse(typeof(LokakiOld.LANGUAGES), sSystemLanguage);
            ...
            {
                return LokakiOld.LANGUAGES.English;
            }
        ...
        public static string GetEnumLokakiText(System.Enum eEnum, int iIndex)
        {
            ...
            if (eEnum != null)
            {
                ...
                {
                    sValue = LokakiOld.GetText(iLokakiId);
                }
