...
[CustomEditor(typeof(SoundListComponent))]
public class SoundListComponentInspector : Editor
{
    private ReorderableList m_pSoundList;
    private SoundListComponent m_Myself;

    private void OnEnable()
    {
        m_Myself = (SoundListComponent)this.target;
