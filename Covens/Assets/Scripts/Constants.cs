...
public class CovenConstants : MonoBehaviour
{
    ...
    public static string hostAddress
    {
        ...
        get
        {
            ...
            {
                return "http://192.168.0.106:9000/api/";
            }
            else
            {
    ...
    public static string wssAddress
    {
        ...
        {
#if GUSTAVO_LOCAL
                return "http://192.168.0.106:8084/socket.io/?";
#elif UNITY_EDITOR
            ...
            {
                return "https://35.186.184.246:8084/socket.io/";
            }
    ...
    public static string chatAddress
    {
        ...
        {
#if GUSTAVO_LOCAL
                return "http://192.168.0.106:8083/socket.io/";
#elif UNITY_EDITOR
            ...
            {
                return "http://35.186.184.246:8084:8083/socket.io/";
            }
