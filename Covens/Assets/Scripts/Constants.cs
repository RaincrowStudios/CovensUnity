...
public class CovenConstants : MonoBehaviour
{
    ...
    public static string hostAddress
    {
        ...
        {
#if GUSTAVO_LOCAL
                return "http://192.168.0.129:8080/api/";
#elif UNITY_EDITOR
            ...
            {
                return "http://192.168.0.129:9000/api/";
            }
            else
            {
    ...
    public static string wssAddress
    {
        ...
        {
#if GUSTAVO_LOCAL
                return "http://192.168.0.129:8084/socket.io/?";
#elif UNITY_EDITOR
    ...
    public static string chatAddress
    {
        ...
        {
#if GUSTAVO_LOCAL
                return "http://192.168.0.129:8083/socket.io/";
#elif UNITY_EDITOR
    ...
    public static string wsMapServer
    {
        get
        {
            ...
            {
                return "http://192.168.0.129:8081/";
            }
            else
            {
