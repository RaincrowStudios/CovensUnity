...
public class HelpshiftDemo : MonoBehaviour
{
    ...
    {
        if (path.StartsWith("content://", System.StringComparison.OrdinalIgnoreCase))
        {
    ...
    void Awake()
    {
        ...
        faq.onClick.AddListener(onShowFAQsClick);

        contact.onClick.AddListener(onCustomContactUsClick);

        _support = HelpshiftSdk.getInstance();
        string apiKey = "5c8c94e31096cba9a17f38b0220521ec";
        string domainName = "freetrialraincrow-studios.helpshift.com";
        string appId;
#if UNITY_ANDROID
        appId = "freetrialraincrow-studios_platform_20191029205619755-7dbc510fe705ab4";
#elif UNITY_IOS
    ...
    public void onShowFAQSectionClick()
    {
        ...
        try
        {
            System.Convert.ToInt16(inputFieldCo.text);
