...
//    }
    ...
    public void ShowCard(MarkerSpawner.MarkerType Type)
    {
        ...
        if (Type == MarkerSpawner.MarkerType.spirit)
        {
			...
			//Don't really know if this is supposed to go here, but I do think it would be useful
			currCard = Instantiate (SpiritCard);

			//disregard this
			//currCard.GetComponent<SpiritSelectionCard> ().SetupSpiritCard (data);
...
//            }
//			WitchCard.GetComponent<PlayerSelectionCard>().ChangeDegree();
...
//                {
//					//Witch Card
//					currCard.GetComponent<PlayerSelectionCard>().SetCardImmunity(true);
//                }
//                else
//                {
//					//
...
//            }
        ...
        else if (Type == MarkerSpawner.MarkerType.location)
        {
			...
			//currCard = Utilites.InstantiateUI(LocationCard, parentUI);
			currCard = Instantiate (LocationCard);
            
			//Can probably get rid of the below line
			//locationTitle.text = MarkerSpawner.SelectedMarker.displayName;

			//UPDATED LOCATION SELECTION
			//LocationCard.GetComponent<LocationSelectionCard>().SetupLocationCard();
