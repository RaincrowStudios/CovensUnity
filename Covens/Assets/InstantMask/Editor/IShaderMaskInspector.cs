	...
	*/
	...
	public override void OnInspectorGUI ()
	{
		...
		if (IMScript.BaseImageFoldoutBool) {
			...
			#if UNITY_2017_1_OR_NEWER
			IMScript.BaseImageWrapModeU = EditorGUILayout.IntPopup ("Base Image WrapMode U axis", IMScript.BaseImageWrapModeU, WrapModeText, WrapModeNum);
			IMScript.BaseImageWrapModeV = EditorGUILayout.IntPopup ("Base Image WrapMode V axis", IMScript.BaseImageWrapModeV, WrapModeText, WrapModeNum);
			#else
			IMScript.BaseImageOldWrapMode = EditorGUILayout.IntPopup ("Base Image WrapMode", IMScript.BaseImageOldWrapMode, OldWrapModeText, OldWrapModeNum);
			#endif
