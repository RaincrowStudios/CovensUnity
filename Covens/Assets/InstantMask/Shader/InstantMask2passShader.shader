...
Shader "Custom/InstantMask2passShader" {
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed _ResultOpacity;
			fixed _MaskVisibility;
			fixed _VisibleMaskNumber;
			...
			fixed4 frag (v2f i) : COLOR
			{
				...
				if(_AlphaCutoff>=1
					|| col.a<0.001
					|| _AlphaCutoff>0 && col.a<=_AlphaCutoff)
				{
