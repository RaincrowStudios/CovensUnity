...
public class CreditsHandler : MonoBehaviour {
	...
	void CreditScroll() {
		LeanTween.moveLocalY (ScrollingRect, -2314f, 0.01f*Speed);
			LeanTween.alphaCanvas (CreditsP_CG, 1f, 0.5f*Speed).setEase(LeanTweenType.easeOutCubic);

			LeanTween.value(0f,1f, 1f*Speed).setOnComplete(() => {
				LeanTween.value(0f,1f, 5.5f*Speed).setOnComplete(() => { //time to fade title
			...
			LeanTween.moveLocalY (ScrollingRect, 6863f, 45f*Speed).setEase(LeanTweenType.easeOutSine).setOnComplete(() => {
				LeanTween.value(0f,1f,3f*Speed).setOnComplete(() =>	closeCredits());
			});
				LeanTween.value(0f,1f, 10f*Speed).setOnComplete(() => { //time for spiritOne
					AnimateSpiritOne();
					LeanTween.value (0f, 1f, 6f*Speed).setOnComplete(() => { //time for midrunes
						MidRuneL.SetActive(true);
						MidRuneR.SetActive(true);
						LeanTween.alphaCanvas (MidRuneL.GetComponent<CanvasGroup>(), 0.5f, 2f*Speed).setEase(LeanTweenType.easeInCubic);
						LeanTween.alphaCanvas (MidRuneR.GetComponent<CanvasGroup>(), 0.5f, 2f*Speed).setEase(LeanTweenType.easeInCubic);
						LeanTween.value(0f, 1f, 4f*Speed).setOnComplete (() => { //time to fade midrunes
							LeanTween.alphaCanvas (MidRuneL.GetComponent<CanvasGroup>(), 0f, 2f*Speed).setEase(LeanTweenType.easeOutCubic);
							LeanTween.alphaCanvas (MidRuneR.GetComponent<CanvasGroup>(), 0f, 2f*Speed).setEase(LeanTweenType.easeOutCubic);
							LeanTween.value(0f,1f,2f*Speed).setOnComplete(() => { //time for spirit 2
								AnimateSpiritTwo();
							});
						});
	...
	void AnimateSpiritOne () {
		LeanTween.alphaCanvas (Spirit1BG_one, 1f, 1f*Speed).setEase (LeanTweenType.easeInCubic);
		LeanTween.scale (Spirit1BG_oneTrans, postscale, 1.5f*Speed).setEase (LeanTweenType.easeInOutCubic);
		LeanTween.alphaCanvas (Spirit1BG_two, 1f, 1.3f*Speed).setEase (LeanTweenType.easeInCubic);
		LeanTween.scale (Spirit1BG_twoTrans, postscale, 1f*Speed).setEase (LeanTweenType.easeInOutCubic);
		LeanTween.value(0f,1f,0.5f*Speed).setOnComplete(() => {
			LeanTween.alphaCanvas(Spirit1_pic, 1f, 1.2f*Speed).setEase(LeanTweenType.easeInCubic);
			LeanTween.scale (Spirit1_PicTrans, postscale, 1.2f*Speed).setEase(LeanTweenType.easeInOutCubic).setOnComplete(() => {
				LeanTween.scale (Spirit1BG_oneTrans, prescale, 5f*Speed).setEase (LeanTweenType.easeInCubic);
				LeanTween.scale (Spirit1BG_twoTrans, prescale, 5f*Speed).setEase (LeanTweenType.easeInCubic);
				LeanTween.scale (Spirit1_PicTrans, idlescale, 5f*Speed).setEase(LeanTweenType.easeInCubic);
			});
		});
		LeanTween.value (0f, 1f, 5f*Speed).setOnComplete (() => {
			LeanTween.alphaCanvas (Spirit1BG_one, 0f, 2f*Speed).setEase (LeanTweenType.easeOutCubic);
			LeanTween.alphaCanvas (Spirit1BG_two, 0f, 2f*Speed).setEase (LeanTweenType.easeOutCubic);
			LeanTween.alphaCanvas (Spirit1_pic, 0f, 1.5f*Speed).setEase(LeanTweenType.easeOutCubic);
		});
	}
	void AnimateSpiritTwo() {
		LeanTween.alphaCanvas (Spirit2BG_one, 1f, 1f*Speed).setEase (LeanTweenType.easeInCubic);
		LeanTween.scale (Spirit2BG_oneTrans, postscale, 1.5f*Speed).setEase (LeanTweenType.easeInOutCubic);
		LeanTween.alphaCanvas (Spirit2BG_two, 1f, 1.3f*Speed).setEase (LeanTweenType.easeInCubic);
		LeanTween.scale (Spirit2BG_twoTrans, postscale, 1f*Speed).setEase (LeanTweenType.easeInOutCubic);
		LeanTween.value(0f,1f,0.5f*Speed).setOnComplete(() => {
			LeanTween.alphaCanvas(Spirit2_pic, 1f, 1.2f*Speed).setEase(LeanTweenType.easeInCubic);
			LeanTween.scale (Spirit2_picTrans, postscale, 1.2f*Speed).setEase(LeanTweenType.easeInOutCubic).setOnComplete(() => {
				LeanTween.scale (Spirit2BG_oneTrans, prescale, 5f*Speed).setEase (LeanTweenType.easeInCubic);
				LeanTween.scale (Spirit2BG_twoTrans, prescale, 5f*Speed).setEase (LeanTweenType.easeInCubic);
				LeanTween.scale (Spirit2_picTrans, idlescale, 5f*Speed).setEase(LeanTweenType.easeInCubic);
			});
		});
		LeanTween.value (0f, 1f, 5f*Speed).setOnComplete (() => {
			LeanTween.alphaCanvas (Spirit2BG_one, 0f, 2f*Speed).setEase (LeanTweenType.easeOutCubic);
			LeanTween.alphaCanvas (Spirit2BG_two, 0f, 2f*Speed).setEase (LeanTweenType.easeOutCubic);
			LeanTween.alphaCanvas (Spirit2_pic, 0f, 1.5f*Speed).setEase(LeanTweenType.easeOutCubic);
		});
	}
	public void closeCredits() {
		CloseCredits.interactable = false;
		LeanTween.pauseAll ();
		LeanTween.alphaCanvas (CreditsP_CG, 0f, 1f*Speed).setEase(LeanTweenType.easeOutCubic).setOnComplete (() => Destroy (gameObject));
	}
}