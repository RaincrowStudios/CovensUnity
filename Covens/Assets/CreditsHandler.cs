...
//        ScrollingRect.transform.GetChild(2).GetComponent<CanvasGroup>().alpha = 1;
    ...
    void CreditScroll()
    {
        ...
        {
            LeanTween.value(0f, 1f, 5.5f * Speed).setOnComplete(() =>
            { //time to fade title
...
//                LeanTween.alphaCanvas(u, 0f, 2f * Speed).setEase(LeanTweenType.easeOutCubic);
            ...
            LeanTween.value(0f, 1f, 10f * Speed).setOnComplete(() =>
            { //time for spiritOne
                AnimateSpiritOne();
                LeanTween.value(0f, 1f, 6f * Speed).setOnComplete(() =>
                { //time for midrunes
                    ...
                    LeanTween.value(0f, 1f, 4f * Speed).setOnComplete(() =>
                    { //time to fade midrunes
                        ...
                        LeanTween.value(0f, 1f, 2f * Speed).setOnComplete(() =>
                        { //time for spirit 2
                            AnimateSpiritTwo();
                        });
                    });
