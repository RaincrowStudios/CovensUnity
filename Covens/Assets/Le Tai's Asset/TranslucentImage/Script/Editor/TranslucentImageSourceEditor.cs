...
#region constants
        ...
        public override void OnInspectorGUI()
        {
            ...
            tiSource.BlurConfig = (BlurConfig) EditorGUILayout.ObjectField(
                "Config file",
                tiSource.BlurConfig,
                typeof(BlurConfig),
                false
            ...
            if (tiSource.BlurConfig == null)
            {
                if (GUILayout.Button("Create New Config File"))
                {
                    ...
                    string path = AssetDatabase.GenerateUniqueAssetPath("Assets/Blur Algo1 Config.asset");
            ...
            //Common properties
            tiSource.Downsample = EditorGUILayout.IntSlider(
                new GUIContent(downsampleLabel),
                tiSource.Downsample,
                Min,
                MaxDownsample
            );
