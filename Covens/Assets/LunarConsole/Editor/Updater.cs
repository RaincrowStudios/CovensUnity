...
namespace LunarConsoleEditorInternal
{
    static class Updater
    {
        ...
        {
            LunarConsoleHttpClient downloader = new LunarConsoleHttpClient(LunarConsoleConfig.fullVersion ? ConstantsLC.UpdateJsonURLFull : ConstantsLC.UpdateJsonURLFree);
        ...
        static class PluginVersionChecker
        {
            ...
            {
                return ConstantsLC.Version;
            }
        }

        #region Preferences

        private static readonly string kPrefsKeySkipVersion = ConstantsLC.EditorPrefsKeyBase + ".SkipVersion";
        private static readonly string kPrefsKeyLastUpdateCheckDate = ConstantsLC.EditorPrefsKeyBase + ".LastUpdateCheckDate";
