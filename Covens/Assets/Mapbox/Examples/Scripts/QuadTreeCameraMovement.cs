namespace Mapbox.Examples
{
    ...
    public class QuadTreeCameraMovement : MonoBehaviour
    {
        ...
        private List<double> speedX = new List<double>();
        private List<double> speedY = new List<double>();
        ...
        void UseMeterConversion()
        {
            ...
            if (Input.GetMouseButton(0) && !EventSystem.current.IsPointerOverGameObject())
            {
                ...
                // var latlongDelta = _mapManager.WorldToGeoPosition(_mousePosition);
                // double cSpeedX = latlongDelta.y - lng;
                // double cSpeedY = latlongDelta.x - lat;
                // speedX.Add(cSpeedX);
                // speedY.Add(cSpeedY);
