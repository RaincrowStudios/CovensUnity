...
//			if (raycastHit.transform.tag != "ArenaEnemy" || raycastHit.transform.tag != "ArenaPlayer" || raycastHit.transform.tag != "ArenaFriend" )
//				return;
//
			if (raycastHit.transform.tag != "ArenaEnemy") {
			
			} else if (raycastHit.transform.tag != "ArenaPlayer") {
				
			} else if (raycastHit.transform.tag != "ArenaFriend") {
			} else
				return;
