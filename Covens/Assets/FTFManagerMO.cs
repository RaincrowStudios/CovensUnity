...
public class FTFManagerMO : MonoBehaviour
{
	public static FTFManagerMO Instance { get; set; }
...
//			SpawnBarghest();
	...
	public void Enable(GameObject g, float delay = 1.5f)
	{
		StartCoroutine (enableObject (g, delay));
	}

	IEnumerator enableObject(GameObject g, float delay)
	{
		yield return new WaitForSeconds(delay);
		g.SetActive(false);
	}
