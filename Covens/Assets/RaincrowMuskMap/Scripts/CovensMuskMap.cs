...
namespace Raincrow.Maps
{
    public class CovensMuskMap : MonoBehaviour
    {
        ...
        public int muskZoom { get { return m_MapsService.ZoomLevel; } }
        ...
        private void UpdateBounds()
        {
            ...
            GetCoordinates(m_LocalBotLeft, out lng, out lat);
            ...
            GetCoordinates(m_LocalTopRight, out lng, out lat);
        ...
        {
            LatLng results = m_MapsService.Coords.FromVector3ToLatLng(m_MapCenter.position);
            return new Vector2((float)results.Lng, (float)results.Lat);
        }
